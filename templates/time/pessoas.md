...
Lido pelo `/setup` pra reconhecer a pessoa pelo nome e pré-carregar função + contexto.
...
- **Função:** Onboarding
- **Contexto:** Onboarding em grupo, jornada início do cliente, apresentações de boas-vindas
...
- **Contexto:** Retenção, UX da jornada, churn, coordenação das 4 frentes de trabalho

---

## Projetos ativos (referência pro /setup perguntar sobre contexto)

- **High Ticket:** Lançamento do Debrief Done-for-You (R$6k/mês). Luan é o responsável atual.
...
- **Espionagem / Miro:** Luan monta boards de concorrentes no Miro.
